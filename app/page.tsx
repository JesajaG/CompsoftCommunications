      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/image001-LDWFieKXSQnC4dy6F7wothTkYTxZUa.jpg"
        ...
        <>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-red-50">
            <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover z-0">
              <source
                src="https://ik.imagekit.io/1ejspnv0y/Generated%20File%20September%2023,%202025%20-%206_09PM(1).mp4?updatedAt=1758645618901"
                type="video/mp4"
              />
            </video>
            ...
            >
              ...
              >
                <span className="text-blue-900">Compsoft Communications</span>
              </motion.h1>
              <motion.h2
              ...
              >
                <span className="text-white">Leading IT Solutions Provider</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
